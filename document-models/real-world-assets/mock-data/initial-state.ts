...
export const mockCashAsset: Cash = {
  id: "cash-asset-1",
  type: "Cash",
  spvId: mockSPVs[0].id,
  currency: "USD",
...
export const mockTransaction: GroupTransaction = {
...
export const mockTransactions: GroupTransaction[] =
  allGroupTransactionTypes.map((type, i) => {
    const fees = type !== FEES_PAYMENT ? mockTransaction.fees : null;
    const cashTransaction = mockCashTransaction;
    const fixedIncomeTransaction = [ASSET_PURCHASE, ASSET_SALE].includes(type)
...
export const manyMockTransactions: GroupTransaction[] = [
  ...mockTransactions,
  ...mockTransactions,
  ...mockTransactions,
  ...mockTransactions,
